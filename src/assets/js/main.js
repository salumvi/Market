function  init_funcion(){ (function($) {
    "use strict";
    ...
    function owlCarouselConfig(){
        ...
        if (target.length > 0) {
            target.each(function () {
                ...
                var dataLoop = el.data('owl-loop');
                var dataSpeed = el.data('owl-speed');
                var dataGap = el.data('owl-gap');
                var dataNav = el.data('owl-nav');
                var dataDots = el.data('owl-dots');
                var dataAnimateIn = (el.data('owl-animate-in')) ? el.data('owl-animate-in') : '';
                var dataAnimateOut = (el.data('owl-animate-out')) ? el.data('owl-animate-out') : '';
                var dataDefaultItem = el.data('owl-item');
                var dataItemXS = el.data('owl-item-xs');
                var dataItemSM = el.data('owl-item-sm');
                var dataItemMD = el.data('owl-item-md');
                var dataItemLG = el.data('owl-item-lg');
                var dataItemXL = el.data('owl-item-xl');
                var dataNavLeft = (el.data('owl-nav-left')) ? el.data('owl-nav-left') : '<i class=\'icon-chevron-left\'></i>';
                var dataNavRight = (el.data('owl-nav-right')) ? el.data('owl-nav-right') : '<i class=\'icon-chevron-right\'></i>';
                var duration = el.data('owl-duration');
                var datamouseDrag = (el.data('owl-mousedrag') === 'on') ? true : false;
